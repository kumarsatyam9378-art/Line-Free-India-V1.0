    ...
    <ResponsiveContainer variant="customer">
      <div className="h-full overflow-y-auto animate-fadeIn custom-scrollbar">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          ...
          <button onClick={() => nav('/customer/history')} className="p-3 rounded-xl border border-border bg-card text-sm font-medium flex items-center gap-2 hover:border-primary/30 transition-all" style={{ color: 'var(--color-text)' }}>
            <span>📋</span> Visit History
          </button>
          <button onClick={() => nav('/customer/notifications')} className="p-3 rounded-xl border border-border bg-card text-sm font-medium flex items-center gap-2 hover:border-primary/30 transition-all relative" style={{ color: 'var(--color-text)' }}>
          ...
          <button onClick={() => nav('/customer/subscription')} className="p-3 rounded-xl border border-border bg-card text-sm font-medium flex items-center gap-2 hover:border-primary/30 transition-all" style={{ color: 'var(--color-text)' }}>
            <span>⭐</span> Subscription
          </button>
          <button onClick={toggleTheme} className="p-3 rounded-xl border border-border bg-card text-sm font-medium flex items-center gap-2 hover:border-primary/30 transition-all" style={{ color: 'var(--color-text)' }}>
        ...
        {!showDeleteConfirm ? (
          ...
          <div className="p-4 rounded-2xl bg-danger/10 border border-danger/30 animate-fadeIn">
            ...
            <div className="flex gap-2">
              <button onClick={() => { setShowDeleteConfirm(false); setDeleteInput(''); setDeleteError(''); }} className="flex-1 p-3 rounded-xl border border-border text-sm" style={{ color: 'var(--color-text)' }}>Cancel</button>
